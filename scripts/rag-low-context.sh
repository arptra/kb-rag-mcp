...
export KB_SEARCH_EXCERPT_TOKENS="${KB_SEARCH_EXCERPT_TOKENS:-240}"
export KB_SEARCH_CONTEXT_TOKENS="${KB_SEARCH_CONTEXT_TOKENS:-800}"
export KB_SEARCH_MAX_CHUNKS_PER_DOCUMENT="${KB_SEARCH_MAX_CHUNKS_PER_DOCUMENT:-1}"
export KB_DOCUMENT_CONTEXT_TOKENS="${KB_DOCUMENT_CONTEXT_TOKENS:-600}"
