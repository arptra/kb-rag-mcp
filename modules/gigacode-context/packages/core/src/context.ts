...
export class Context {
    ...
    constructor(config: ContextConfig = {}) {
        // Initialize services
        if (!config.embedding) {
            throw new Error('Embedding is required. This offline fork never selects a network embedding provider implicitly.');
        }
 ...
 */
    ...
    isLanguageSupported(language: string): boolean {
        ...
        // The dependency-free character splitter supports any text format.
        return true;
    }
        ...
        if (splitterName === 'AstCodeSplitter') {
            ...
            return {
                ...
                reason: isSupported
                    ...
                    : 'Language not supported by AST, will use local character splitting'
            };
        } else {
            return {
                strategy: 'langchain',
                reason: 'Using local character splitter directly'
            };
        }
    }
}
